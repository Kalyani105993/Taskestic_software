						...
						<div class="col-6">
						 <ol class="breadcrumb" >
						    <li class="breadcrumb-item"><a i class="material-icons fixed-plugin-button-nav cursor-pointer " href='workspace.jsp'> home </i></a></li>
						     <h6 class="font-weight-bolder mb-0 breadcrumb-item active">Activity</h6>
						  </ol>
									...
									<form class="multisteps-form__form m-0">
										<div class="row p-2">
											...
											<div class="col-md-3 col-sm-6" id="activitystartDateColid">
												...
												<span id="errormessageforfromdateIdact" class="err-msg" 
													  style="display : none ; color: red;">Please select a date !</span>
											    <span
													id="errMsgDateCompareact" class="err-msg"
											...
											<div class="col-md-3 col-sm-6" id="activityendDateColid">
												...
												<span id="errormessagefortodateIdact" class="err-msg"
												style="display: none; color: red">Please select a date!...</span>
						
											</div>
											<div class="col-md-3 col-sm-6 text-end">
												<button class="btn btn-icon btn-2 btn-dark" id="search"
													type="button" onclick="loadActivity()">
...
<script type="text/javascript">
	...
	function loadActivity(){
		...
		$('#errormessageforfromdateIdact').hide();			
		$('#errormessagefortodateIdact').hide();
		$('#errMsgDateCompareact').hide();	
		...
		if($('#activityselect_filter_id').val() == "custom_dates"){
			...
			if (from_date == ""){
				$('#errormessageforfromdateIdact').show();		

			}
			else if (to_date == ""){
				$('#errormessageforfromdateIdact').hide();		
				$('#errormessagefortodateIdact').show();
			}
			else if (from_date > to_date ){
				$('#errormessageforfromdateIdact').hide();	
				$('#errormessagefortodateIdact').hide();
				
				$('#errMsgDateCompareact').show();		
			}
			else if (diffDays > 90){
