...
/**
 * DatabaseException denotes a generic runtime data access (SQL) exception. By
 * declaring the exception as a descendant of RuntimeException, the jdbc
 * framework give the programmer the option of whether or not to catch the
 * exception.
 * 
 */
public abstract class DatabaseException extends RuntimeException {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2400773047439432947L;
	...
	public DatabaseException(String msg, SQLException e) {
		...
		// added by Paolo Orru, to fix NullPointerException for PostgreSQL Database
		// Exception
	 ...
	 */
	public void applyDataIntegrityViolationRecovery() {
