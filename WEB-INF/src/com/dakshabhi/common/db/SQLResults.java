...
public class SQLResults {
	...
	/**
	 * Constructor creates ArrayList objects and initializes the dbType and
	 * columnCount
	 * 
	 * @param dbType
	 * @param columnCount
	...
	/**
	 * Adds an object (a field value from a SELECT) to the sql results
	 * container)
	 * 
	 * @param o
	 */
	...
	/**
	 * GetObject returns an object in the ArrayList results given a row and
	 * column index
	 * 
	 * @param row
	 * @param col
	...
	private int getColumnIndex(String columnName) {
		...
		if (colIndex < 0)
			throw ExceptionFactory.getException(dbType, "Invalid column name: "
					+ columnName);
		return (colIndex);
	}
	...
	/**
	 * Gets the value of the field corresponding to (row, col) as a
	 * java.sql.Date
	 * 
	 * @param row
	 *            int
	...
	/**
	 * Gets the value of the field corresponding to row, columnName as a
	 * java.sql.Date
	 * 
	 * @param row
	 *            int
	...
	/**
	 * Returns the contents of SQLResults in a text table. This method is useful
	...
	public String toString() {
		...
		for (int col = 0; col < columnCount; col++) {
			String formattedColName = formatWithSpaces((String) columnNames
					.get(col));
	...
	/**
	 * Formats a string by adding spaces on the end if the string is shorter
	 * than toStringFormatWidth, or truncates string if it is too long.
	 * 
	 * @param s
	 *            String
	 * @return String
