package com.dakshabhi.pms.employees.dtos;

public class CEmployeeInfoDTO {
	...
	public int getRemporting_to() {
		return remporting_to;
	}

	public void setRemporting_to(int remporting_to) {
		this.remporting_to = remporting_to;
	}
