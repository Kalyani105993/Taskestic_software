package com.dakshabhi.pms.projectworkpacks.dtos;

public class CProjectworkpacksDTO {
	
	private int project_workpack_id;
	private int company_id;
	private int project_id;
	private int workpack_id;
	private String date_added;
	private int workpack_rate;
	...
	public int getProject_workpack_id() {
		return project_workpack_id;
	}
	public void setProject_workpack_id(int project_workpack_id) {
		this.project_workpack_id = project_workpack_id;
	}
	...
	public int getWorkpack_rate() {
		return workpack_rate;
	}
	public void setWorkpack_rate(int workpack_rate) {
